...
inline int ssd1306_get_font(uint8_t character) {
    if (character >= 'A' && character <= 'Z') {
        ...
        switch (character) {
            //case '!': return 37;    // Índice 36
            case '-': return 43;     // Índice 38
            case '+': return 38;     // Índice 37
            case '=': return 40;     // Índice 39
            case 0xB0: return 41;   // Código ASCII para '°' (grau)
            case ':': return 42;     // Índice 41
            case '|': return 39;     // Índice 42
            default:  return 0;      // Espaço em branco
        }
    }
}
